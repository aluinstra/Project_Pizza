...
function createEventHandlers() {
  var _loop = function _loop(_i) {
    categoryElements[_i].onchange = function (e) {
      getIngredients(e, _i);
      console.log("hi");
  ...
  for (var _i = 0; _i < categoryElements.length; _i++) {
    _loop(_i);
  ...
  function getIngredients(e, i) {
    ...
    axios.get("/categories/".concat(category_id, "/ingredients")).then(function (response) {
...
function addRow() {
  console.log("yello");
  var row = document.getElementById("recipeTableRow"); // console.log(row);

  var table = document.getElementById("ingredients_selection"); // find table to append to
...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelector("#checkButton").addEventListener("click", checkIngredient);
});

function checkIngredient() {
  console.log("hi d"); // let ingredientsArray = [];

  var ingredients = document.getElementsByClassName("ingredients");
  ingredientsArray = [].slice.call(ingredients);
  ingredientsArray = ingredientsArray.map(function (item) {
    return item.value;
  });
  console.log(ingredientsArray);
  axios.get("/pizzas/filter", {
    params: {
...
__webpack_require__(/*! C:\Users\Luin\OneDrive\Projects Script\Project_Pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Luin\OneDrive\Projects Script\Project_Pizza\resources\css\app.css */"./resources/css/app.css");
